(() => {
  ...
  const ITEM_DEFINITIONS = [
    { name: "8th's Sword", assetId: 98131647273476 },
    { name: 'Anvil', assetId: 87373295347365 },
    { name: 'Aqua Shard', assetId: 134586230895171 },
    { name: 'Battlepass EXP', assetId: 114328894217766 },
    { name: "Beginner's Ticket", assetId: 92708131788468 },
    { name: 'Black Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Blue Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Bunny Candy', assetId: 114002509716577 },
    { name: 'Burning Fruit', assetId: 123556219241960 },
    { name: 'Cobalt Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Cosmic Magic', assetId: 121833778269255 },
    { name: 'Crimson Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Crimson Vial', assetId: 94381461409309 },
    { name: 'Crow Relic', assetId: 76923936793147 },
    { name: "Crow's Ring", assetId: 87203191785095 },
    { name: 'Crown', assetId: 137524761353956 },
    { name: 'Cursed Boba', assetId: 86406261866497 },
    { name: 'Cursed Book', assetId: 82295494861028 },
    { name: 'Cursed Timber', assetId: 136417792145357 },
    { name: 'Delicious Pie', assetId: 112080191044214 },
    { name: 'Developer Hat Gifter', assetId: 87919600502988 },
    { name: 'Elixir of Life', assetId: 125147427945388 },
    { name: 'Equipment Lock', assetId: 98479956634965 },
    { name: 'Equipment Reroll', assetId: 81367008512026 },
    { name: 'Equipment Scrap', assetId: 138259000495300 },
    { name: 'Event Coin', assetId: 122283537900027 },
    { name: 'Expedition Coin', assetId: 133127153759220 },
    { name: 'Frown Fruit', assetId: 131512075092964 },
    { name: 'Fuel Cell', assetId: 104121621042535, aliases: ['Expedition Fuel'] },
    { name: 'Gem', assetId: GEM_ASSET_ID },
    { name: 'Geode', assetId: 138904987734280 },
    { name: 'Giant Hammer', assetId: 121596631364316 },
    { name: 'Gold', assetId: 135239612382433 },
    { name: 'Green Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Hollowed Visor', assetId: 117343950081695 },
    { name: 'Holy Pendant', assetId: 86605157198890 },
    { name: 'Jaw Skull', assetId: 109276412279273 },
    { name: 'Joker of the Nonsensical Pirates', assetId: 137441898503450 },
    { name: 'Leaderboard Capsule', assetId: 94800308177665 },
    { name: 'Luck Potion', assetId: 77171016111697 },
    { name: 'Lush Dirt', assetId: 92084519126759 },
    { name: 'Magical Amulet', assetId: 71145581264662 },
    { name: 'Mana Flask', assetId: 94316038056476 },
    { name: 'Orange Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Payload EXP', assetId: 124721389072864 },
    { name: 'Pink Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Player EXP', assetId: 117500362262257 },
    { name: 'Puppet Heart', assetId: 84111339695232 },
    { name: 'Purple Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Raid Token', assetId: 136240850940008 },
    { name: 'Rainbow Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Random Item', assetId: 71123287869055 },
    { name: 'Red Flower', assetId: 132509394462607 },
    { name: 'Red Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Repair Hammer', assetId: 80027541580589 },
    { name: 'Research Point', assetId: 121721703265529 },
    { name: 'Salmon', assetId: 79569140573560 },
    { name: 'Spirit City Totem', assetId: 104984239057202 },
    { name: 'Spirit Token', assetId: 114823475742161, aliases: ['Spirit City Token'] },
    { name: 'Sprite (Blue)', assetId: 126917557220272 },
    { name: 'Sprite (Green)', assetId: 124445225421161 },
    { name: 'Sprite (Grey)', assetId: 72115941471722 },
    { name: 'Sprite (Pink)', assetId: 80102116113968 },
    { name: 'Sprite (Purple)', assetId: 86386797861874 },
    { name: 'Sprite (Rainbow)', assetId: 90878706773915 },
    { name: 'Sprite (Red)', assetId: 112690032318535 },
    { name: 'Sprite (Yellow)', assetId: 92252032301356 },
    { name: 'Stat Lock', assetId: 140365526846292 },
    { name: 'Stat Reroll', assetId: 136060410683336 },
    { name: 'Student ID', assetId: 125687910025203 },
    { name: 'Super Luck Potion', assetId: 133531148635869 },
    { name: 'Tome', assetId: 126371997272787 },
    { name: 'Trait Crystal', assetId: 112860527247753 },
    { name: 'Trait Reroll', assetId: 125552362949538 },
    { name: 'Unit EXP', assetId: 118877874477600 },
    { name: 'Unknown Bundle', assetId: 91508523300786 },
    { name: 'Villain Battlepass EXP', assetId: 87293290668489 },
    { name: 'Villain Chest', assetId: 107628615140722 },
    { name: 'Villain Coins', assetId: 125718058013287, aliases: ['Villain Currency'] },
    { name: 'White Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Yellow Unit Indicator Color', assetId: 86214153130821 },
    { name: 'Yen', assetId: 131430939615770 },
  ];
  ...
  function getGemAmount(player) {
    ...
    for (const [name, amount] of Object.entries(player?.inventory || {})) {
      if (normalizeItemName(name) === 'gem') total += Number(amount) || 0;
    }
    return total;
  }
  ...
  function filteredPlayers() {
    ...
    return state.players.filter((player) => {
      ...
      const itemMatch = Object.keys(player.inventory || {}).some((rawName) => {
        const definition = itemDefinition(rawName);
        ...
        <td>
          <div class="inventory-item">
            ...
            <div class="inventory-item-copy">
              ...
              ${normalizeItemName(item.rawName) !== normalizeItemName(item.displayName)
                ? `<small>${escapeHtml(item.rawName)}</small>`
                : ''}
            </div>
          </div>
        </td>
