...
## v1.7.1
- Tracker automatically detects the current Universe game name through the Roblox Games API.
- Tracker automatically detects the current Place name with MarketplaceService.
- The web card and Details page show the detected game and child-place name.
- `PLACE_INFO` is optional and only needed when you want to override Roblox's names.


## v1.7.2
- Masked player names in the Recent Sync panel.
