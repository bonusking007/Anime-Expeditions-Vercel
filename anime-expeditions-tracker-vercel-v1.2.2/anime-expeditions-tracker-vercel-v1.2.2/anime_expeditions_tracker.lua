...
local API_URL = "https://YOUR-PROJECT.vercel.app/api/update"
local API_KEY = "CHANGE-THIS-TO-THE-SAME-TRACKER-API-KEY"
...
if getgenv().ANIME_EXPEDITIONS_TRACKER_STOP then
...
getgenv().ANIME_EXPEDITIONS_TRACKER_STOP = function()
    Running = false
end
...
local function sendSnapshot()
    ...
    if StatusCode == 200 then
        print("ANIME EXPEDITIONS TRACKER UPDATED")
        return true
    end
